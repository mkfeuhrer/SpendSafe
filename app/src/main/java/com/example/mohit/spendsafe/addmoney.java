    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.execSQL("insert into add_money values ('" + amount_text + "','" + descrip_text + "','" + date_text + "','" + time_text + "');");
                Toast.makeText(addmoney.this,"First Add",Toast.LENGTH_LONG).show();
                Intent i = new Intent(addmoney.this, home.class);
                startActivity(i);
                finish();
            }
        });
